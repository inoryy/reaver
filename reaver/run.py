...
def main(argv):
    ...
    agent = agent_cls[args.agent](env.obs_spec(), env.act_spec(), sess_mgr=sess_mgr, n_envs=args.envs)
    agent.logger = rvr.utils.StreamLogger(args.envs, args.log_freq, args.log_eps_avg, sess_mgr, expt.log_path)
